##规则包名
java.tars.jax-rs.web.scalaj-http.jax-rs-scalaj-http-open-redirect-uri-params.jax-rs-scalaj-http-open-redirect-uri-params
##规则ID
jax-rs-scalaj-http-open-redirect-uri-params
