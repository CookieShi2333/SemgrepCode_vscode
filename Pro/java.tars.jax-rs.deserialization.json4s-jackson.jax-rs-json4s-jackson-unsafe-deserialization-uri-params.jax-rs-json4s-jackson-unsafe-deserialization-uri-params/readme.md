##规则包名
java.tars.jax-rs.deserialization.json4s-jackson.jax-rs-json4s-jackson-unsafe-deserialization-uri-params.jax-rs-json4s-jackson-unsafe-deserialization-uri-params
##规则ID
jax-rs-json4s-jackson-unsafe-deserialization-uri-params
