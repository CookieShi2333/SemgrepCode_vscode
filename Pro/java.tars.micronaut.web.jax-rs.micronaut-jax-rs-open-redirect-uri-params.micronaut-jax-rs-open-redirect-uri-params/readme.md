##规则包名
java.tars.micronaut.web.jax-rs.micronaut-jax-rs-open-redirect-uri-params.micronaut-jax-rs-open-redirect-uri-params
##规则ID
micronaut-jax-rs-open-redirect-uri-params
