...
public class Tests {
  ...
  public static void testSetFeatureSecreProcessing2() throws SAXException {
    File xsdFile = new File("payloads/input-with-schema/ok-input-schema.xsd");
    SchemaFactory sf = SchemaFactory.newInstance(XMLConstants.W3C_XML_SCHEMA_NS_URI);
    Schema schema = sf.newSchema(xsdFile);
    //ok: validator-xxe
  ...
  public static void testAccessExternalDTD2() throws SAXException {
    File xsdFile = new File("payloads/input-with-schema/ok-input-schema.xsd");
    SchemaFactory sf = SchemaFactory.newInstance(XMLConstants.W3C_XML_SCHEMA_NS_URI);
    Schema schema = sf.newSchema(xsdFile);
    //ok: validator-xxe
