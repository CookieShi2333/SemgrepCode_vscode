    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            javax.naming.NamingEnumeration<javax.naming.directory.SearchResult> results =
                    // ruleid: tainted-ldapi-from-http-request-deepsemgrep
...
public class BenchmarkTest00630 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean found = false;
            javax.naming.NamingEnumeration<javax.naming.directory.SearchResult> results =
                    // deeptodoruleid: tainted-ldapi-from-http-request-deepsemgrep
...
public class BenchmarkTest00021 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean found = false;
            javax.naming.NamingEnumeration<javax.naming.directory.SearchResult> results =
                    // ok: tainted-ldapi-from-http-request-deepsemgrep
                    ctx.search(base, filter, filters, sc);
            while (results.hasMore()) {
                javax.naming.directory.SearchResult sr =
                        (javax.naming.directory.SearchResult) results.next();
