...
class ConstructorExample{
  ...
  private final TransformerFactory trfmfactory;

  public ConstructorExample(TransformerFactory factory){this(factory)}
  ConstructorExample(TransformerFactory factory){
    factory.setFeature(XMLConstants.FEATURE_SECURE_PROCESSING, true);
    this.trfmfactory = factory;
  }

  public void SomeMethod(File input){
    StreamSource source = new StreamSource(input);
    StreamSource xsltSource = new StreamSource(style);
    //ok: saxtransformerfactory-xxe
    Transformer t = trfmfactory.newTransformer(xsltSource);
  }
}
...
class Foobar {
    ...
    public Foobar(File input) {
        ...
        //ruleid: saxtransformerfactory-xxe
...
public static void testSetFeatureSecreProcessing2() throws TransformerConfigurationException {
  ...
  public static void testAccessExternalDTD2() throws TransformerConfigurationException {
    TransformerFactory tf = SAXTransformerFactory.newInstance();
