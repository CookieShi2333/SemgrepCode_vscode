...
class Foobar {
    ...
    public Foobar(File input) {
        // ruleid: saxbuilder-xxe-parameter-entities
        this.saxBuilder = new SAXBuilder();
        this.saxBuilder.build(input);
    }
    ...
    public void doSmthSecure(File input) {
        // ok: saxbuilder-xxe-parameter-entities
        var saxBuilder = new SAXBuilder(XMLReaders.XSDVALIDATING);
...
public class Tests {
    ...
    static File input = new File("payloads/input-with-parameter-entity/input.xml");
