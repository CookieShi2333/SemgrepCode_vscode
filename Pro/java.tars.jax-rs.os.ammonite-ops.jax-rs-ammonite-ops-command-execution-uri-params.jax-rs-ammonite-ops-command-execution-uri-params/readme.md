##规则包名
java.tars.jax-rs.os.ammonite-ops.jax-rs-ammonite-ops-command-execution-uri-params.jax-rs-ammonite-ops-command-execution-uri-params
##规则ID
jax-rs-ammonite-ops-command-execution-uri-params
